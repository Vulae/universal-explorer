...
impl VtfTexture {
    ...
    pub fn to_image(&self) -> DynamicImage {
        ...
        match self.format {
            ...
            TextureFormat::DXT1 => DynamicImage::ImageRgba8(crate::util::texture::bc::decode_bc1(&self.data, self.width(), self.height(), (0, 0, 0, 255))),
            ...
            TextureFormat::DXT1_ONEBITALPHA => DynamicImage::ImageRgba8(crate::util::texture::bc::decode_bc1(&self.data, self.width(), self.height(), (0, 0, 0, 0))),
